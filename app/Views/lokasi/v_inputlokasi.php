    ...
    <div class="col-sm-4">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="jam_operasional">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="waktu_tunggu">
...
<script>
    ...
    const map = L.map('map', {
        center: [2.969945620170663, 99.66236376070265],
        zoom: 13,
        layers: [peta4]
    });
    ...
    var curLocation = [2.969945620170663, 99.66236376070265];
